            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden mb-6 shadow-sm">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 block h-60 overflow-y-auto"> 
                    {returnProducts.map((product, index) => (
                      <tr key={product.id} className="hover:  table-row w-full table"> {/* Ensure rows are table-row display */}
