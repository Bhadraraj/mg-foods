...
  onDeleteMasterIngredient: (id: string) => void; // Destructure the new prop
}
...
              <tr>
                {/* Headers matching image_7a05a1.png */}
...
                  {/* Selling Price and Total Ingredients: Placeholder values */}
                  <td className="px-4 py-3 text-sm text-gray-900">₹{ ((ing as any).sellingPrice || 2820).toFixed(2) }</td> {/* Example selling price */}
                  <td className="px-4 py-3 text-sm text-gray-900">{ing.currentStock}</td> {/* Using currentStock as total ingredients */}
