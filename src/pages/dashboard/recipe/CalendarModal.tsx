...
const CalendarModal: React.FC<CalendarModalProps> = ({
  ...
  const handleDayClick = (day: number | null, month: number, year: number, type: 'from' | 'to') => {
    ...
    if (type === 'from') {
      ...
      // If fromDate becomes after toDate, adjust toDate
      if (selectedDate > toDate) {
        setToDate(selectedDate);
      }
    } else {
      setToDate(selectedDate);
      // If toDate becomes before fromDate, adjust fromDate
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 p-6 relative">
        ...
        <h2 className="text-xl font-semibold mb-6">Add New</h2> {/* Title matching image_7a119f.png */}
